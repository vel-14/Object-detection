...
if options == 'Home':
    ...
    with col1:
        colored_text = '<span style="color: Yellow;">This application is designed to detect whether Spiderman (portrayed by Tom Holland) is present in a given image. It utilizes the YOLOv8 model to accurately identify and confirm his presence.</span>'
